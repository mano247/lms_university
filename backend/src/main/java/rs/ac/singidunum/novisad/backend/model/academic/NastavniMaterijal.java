...
public class NastavniMaterijal {
	...
	public NastavniMaterijal(Long id, String naslov, String autori, String godinaIzdavanja, String izdavac, String opis,
			String url, Ishod ishod, Predmet predmet,int kolicina,int izdato) {
		super();
		this.id = id;
		this.naslov = naslov;
		this.autori = autori;
	...
	public NastavniMaterijal(Long id, String naslov, String autori, int brojStrana, String izdavac, String opis) {
		super();
		this.id = id;
		this.naslov = naslov;
		this.autori = autori;
